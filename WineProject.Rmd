...
![Alt text](\Users\Wendy Marin\OneDrive - Universidad del rosario\Documentos\Caret R\Wine\Images\pH.png)
...
Thus, the value of an algorithm lies in its purpose . On the one hand, if the objective is interpretability, then it makes sense to sacrifice some accuracy (as I did). On the other hand, if the goal is predictability, then one may prefer to lose interpretability (as Cortez et al. did) [11]. 
